    ...
    public class Q14_Pair<K, V> {
        private K key;
        private V value;
        // Constructor
        public Q14_Pair(K key, V value) {
            this.key = key;
            this.value = value;
        }
        ...
        public static void main(String[] args) {
           ...
           Q14_Pair<Integer, String> pair1 = new Q14_Pair<>(1, "One");
            // Creating a Pair with String key and Double value
           Q14_Pair<String, Double> pair2 = new Q14_Pair<>("PI", 3.14);
